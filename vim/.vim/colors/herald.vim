...
if has("gui_running")
	...
	hi MatchParen     guibg=#1F1F1F guifg=#FFA500 gui=bold,underline
...
elseif &t_Co == 256
	...
	" -> Menu
	hi Pmenu          ctermbg=233    ctermfg=130    cterm=none
	...
	hi MatchParen     ctermbg=234  ctermfg=214   cterm=bold,underline
	hi PreProc        ctermbg=234  ctermfg=141   cterm=none
	hi Special        ctermbg=234  ctermfg=227   cterm=none
	hi Todo           ctermbg=236  ctermfg=203   cterm=bold
    ...
    " -> Spelling; also used by YouCompleteMe for errors
    " lighter gray background, red foreground
    hi SpellBad ctermbg=237 ctermfg=203 cterm=none

	" invalid whitespace in file
	hi BadWhiteSpace			ctermbg=233	ctermfg=203	cterm=underline
